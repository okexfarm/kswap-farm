...
import { Heading, Card, CardBody, CardFooter, Text, KswapRoundIcon, Flex, Skeleton } from '@mangofarm/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} KSWAP</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
